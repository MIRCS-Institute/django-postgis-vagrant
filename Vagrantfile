...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision "shell", inline: "export PATH=/opt/anaconda/bin:$PATH; source /home/vagrant/.bashrc; python ~/data/mircs-geogenealogy/mircsgeo/manage.py migrate; python ~/data/mircs-geogenealogy/mircsgeo/manage.py runserver 0.0.0.0:8000 &",
    run: "always",
    privileged:false
